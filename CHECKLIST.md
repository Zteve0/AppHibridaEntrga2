...
- [x] Federico Martínez López: 22 commits completados
...
- [ ] Preparar sustentación: repartir qué presenta cada integrante (sugerencia: Federico = arquitectura y demo, Steve = SASS y estilos, Juan = repo/ramas y build)
